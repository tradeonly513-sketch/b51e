...
const VideoGrid = ({ videos, gridCols, aspectRatio }) => {
  ...
  // Define responsive grid layout with enhanced spacing
  const getGridClasses = () => {
    if (gridCols.includes('grid-cols-1')) {
      return 'grid grid-cols-1 gap-6 sm:gap-8 lg:gap-10'
    } else if (gridCols.includes('grid-cols-2')) {
      return 'grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 lg:gap-10'
      ...
      return 'grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-8 lg:gap-10'
    }
    return 'grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10'
  }
